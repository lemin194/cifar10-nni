...
from nni.nas.nn.pytorch.choice import ChosenInputs, LayerChoice, InputChoice
from nni.nas.nn.pytorch.layers import ModuleList  # pylint: disable=no-name-in-module
